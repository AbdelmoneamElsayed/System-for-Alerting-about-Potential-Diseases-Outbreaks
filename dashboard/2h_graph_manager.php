                    ...
                    <div class="row" style="margin-left:50px;">
					 <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <iframe src="../dashboard/hos2_graph1.php" height="500" width="900" frameBorder="2222"></iframe>
					...
					<div class="row" style="margin-left:50px;">
					 <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <iframe src="../dashboard/hos2_graph2.php" height="500" width="900" frameBorder="2222"></iframe>
					...
					<div class="row" style="margin-left:50px;">
					 <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <iframe src="../dashboard/hos2_graph3.php" height="500" width="900" frameBorder="2222"></iframe>
