<?php
    $query = "SELECT * FROM `add_hospitals`";
                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li  class="submenu" class="active">
                            <a href="hospitals.php"><i class="fa-solid fa-hospital"></i> <span>Governorates</span> <span>  </span> <span class="menu-arrow"></span></a>
							<ul style="display: none;">
							
								<li><a href="hospitals.php">Cairo</a></li>
						...
						<li>
                            <a href="add_new_disease.php"><i class="fa-solid fa-circle-plus"></i> <span>Add new disease </span></a>
                        </li>
                            </ul>
                        </li>
                    </ul>
            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-8 text-right m-b-30">
                        <a class="btn btn-primary btn-rounded float-right" href="add-hospital.php"><i class="fa fa-plus"></i> Add New hospital</a>
                    </div>
                </div>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="blog grid-blog">
                            ...
                            <div class="blog-content">
                                ...
                                <h2 class="blog-title">Hospital name:<span><?php echo $row['hospital_name'];?></span></h2>
                                <p><i class="fa-solid fa-angles-right"></i> <span>  <span>Email:  <span><?php echo $row['email'];?></span></p>
								<p><i class="fa-solid fa-angles-right"></i> <span>  <span>Phone Number:  <span><?php echo $row['phone_number'];?></span></p>
								<p><i class="fa-solid fa-angles-right"></i> <span>  <span>Staff Number: <span><?php  echo $row['staff_number'];?></span></p>
					
								<div class="user-country">
                                <i class="fa fa-map-marker"></i> <span>Location: <?php echo $row['location'];?></span>
                               </div>
							   <br>
							   
                                <a href="" class="read-more"><i class="fa fa-long-arrow-right"></i> Visit</a>
                            </div>
                        </div>
