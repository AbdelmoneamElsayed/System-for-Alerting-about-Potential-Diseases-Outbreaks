                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="blog grid-blog">
                            ...
                            <div class="blog-content">
                                ...
                                <a href="login_1h_employee.php" class="read-more"><i class="fa fa-long-arrow-right"></i> Visit</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="blog grid-blog">
                            ...
                            <div class="blog-content">
                                ...
                                <a href="login_2h_employee.php" class="read-more"><i class="fa fa-long-arrow-right"></i> Visit</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="blog grid-blog">
                            <div class="blog-content">
                                ...
                                <a href="login_3h_employee.php" class="read-more"><i class="fa fa-long-arrow-right"></i> Visit</a>
                            </div>
                        </div>
                    </div>
