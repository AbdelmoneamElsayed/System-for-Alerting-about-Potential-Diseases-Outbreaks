                 ...
                 <div class="row" style="margin-left:50px;">
                        <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    <div class="card-body">
                                       ...
                                       <center> <iframe src="../dashboard/predicted_ebola.php" height="500" width="900" frameBorder="2222"></iframe></center>
                ...
                <div class="row" style="margin-left:50px;">
					 <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <iframe src="../dashboard/con_death_ebola.php" height="500" width="900" frameBorder="2222"></iframe>
                    ...
                    <div class="row" style=" display:flex;  justify-content:center; align-items:center;">
						...
						<div class="col-12 col-md-6 col-lg-4 col-xl-4" style=" margin-right:40px;  ">
                            <div class="card member-panel">
                                <div class="card-header bg-white">
                                    ...
                                    <iframe src="../dashboard/dataframe2.php" height="350" width="300" frameBorder="2222"></iframe>
									<p style="text-align:center;">  From 17th october 2014 till 27 th December 2015</p>
                                </div>
						...
						<div class="col-12 col-md-6 col-lg-4 col-xl-4" style=" margin-right:80px;">
                            <div class="card member-panel" style="width:400px;" >
                                <div class="card-header bg-white">
                                    ...
                                    <iframe src="../dashboard/ancor.php" height="400" width="380" frameBorder="2222"></iframe>
                      ...
                      <div class="col-12 col-md-6 col-lg-8 col-xl-8" >
                            ...
                            <div class="card" style="width:870px; margin-left:30px; ">
                                <div class="card-header" style="margin-left:30px;">
                                    <h4 class="card-title d-inline-block">Details</h4> 
                                </div>
								
								<div class="card-body p-0" >
                                <iframe style="margin-left:40px;" src="../dashboard/dataframe1.php" height="500" width="800" frameBorder="2222"></iframe>
