    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">Egypt Covid-19 Map</h4>
                    </div>
                </div>
				
				<center><iframe src="map_covid_egypt.php" height="500" width="1000" frameBorder="0"></iframe></center>
