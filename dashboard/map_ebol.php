      ...
      <div class="main-wrapper">
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
						...
						<li>
                            <a href="governorates_2.php"><i class="fa-solid fa-hospital"></i> <span>Governorates</span></a>
                        </li>
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">Ebola Map</h4>
                    </div>
                </div>
				<center><iframe src="map_ebola.php" height="500" width="1000" frameBorder="0"></iframe></center>
