                        ...
                        <li class="menu-title">Main</li>
						 ...
						 <li  class="submenu" class="active">
							...
							<ul style="display: none;">
								...
								<li><a href="hospitals_3.php">Cairo</a></li>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-8 col-4">
                        <h4 class="page-title">Data Entry</h4>
                    </div>
                </div> 
                      <br>
                      <br>					  
				         <div class="row" style=" display:flex;  justify-content:center; align-items:center;">
                            ...
                            <div class="form-group text-center">
						     <a href="hos2_result.php">
                               <button type="submit" style="margin-right:500px;"  class="btn btn-primary btn-rounded">CONVERT</button>
							 </a>
                            </div>
						
						 
                            <div class="form-group text-center">
						     <a href="preview_employee_2h_graph.php">
                               <button type="submit" style="font-style: bold"class="btn btn-primary btn-rounded" >NEXT</button>
							 </a>
                           </div>
           ...
           <style>
               ...
               .pd{
                   ...
                   text-align: center;
                       ...
                       <p class="pd">*Note: Please enter data with the following attributes:<br>
                        1-Patient ID-SARS-Cov exam result-gender-Date_reported-Active/Dead then click convert.<br>
                       OR
                           <br>
                       2- Date_reported-Confirmed-Deaths then click next.</p>
                        <input type="file" id="csvFileInput"  style="padding-bottom: 15px ;margin-left: 350px;">
                        
                        <table id="csvRoot"style="margin-left:250px;"></table>
