                    ...
                    <ul>
                        <li class="menu-title">Main</li>
						 ...
						 <li  class="submenu" class="active">
                            <a href="hospitals.html"><i class="fa-solid fa-hospital"></i> <span>Governorates</span> <span>  </span> <span class="menu-arrow"></span></a>
							<ul style="display: none;">
							
								<li><a href="hospitals_3.html">Cairo</a></li>
                    ...
                    <div class="row" style="margin-left:50px;">
					 <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <iframe src="hos2_graph1.php" height="500" width="900" frameBorder="2222"></iframe>
					...
					<div class="row" style="margin-left:50px;">
					 <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <iframe src="hos2_graph2.php" height="500" width="900" frameBorder="2222"></iframe>
					...
					<div class="row" style="margin-left:50px;">
					 <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <iframe src="hos2_graph3.php" height="500" width="900" frameBorder="2222"></iframe>
