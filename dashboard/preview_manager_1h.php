                        ...
                        <h4 class="page-title">Data Entry</h4>
                         ...
                         <div class="row" style=" display:flex;  justify-content:center; align-items:center;">
                            ...
                            <div class="form-group text-center">
						     <a href="1h_graph_admin.php">
                               <button type="submit" style="margin-left:300px;"class="btn btn-primary account-btn">NEXT</button>
							 </a>
                           </div>						   
                        </div>

                       
                        <input type="file" id="csvFileInput"  style="padding-bottom: 15px ;margin-left: 300px;">
                        
                        <table id="csvRoot"style="margin-left: 200px"></table>
